...
IMG_PATCH_SIZE = 16
CROP_STEP = 16 #8 # Needs to be even divisor of IMG_PATCH_SIZE
...
def full_run(train_indices, val_indices, thresh):
    ...
    if val_indices.size:
        val_dir = PROJECT_ROOT+'data_dir_rot/' #TODO back to validation
    ...
    data_dir = PROJECT_ROOT+'data_dir_rot/'
    ...
    with tf.Session() as tf_session:
        ...
        if TRAINING_RUN:
            ...
            for i in train_indices:
                ...
                # Aggregate error & gt
                y_pred = y_pred + get_prediction_for_actual(img_prediction, thresh)
                y = y + get_prediction_for_actual(gt, DEFAULT_THRESHOLD)
        ...
        if val_indices.size:
            ...
            val_score = f1_score(y, y_pred, average='weighted') #TODO: why weighted?
...
def main(argv=None):  # pylint: disable=unused-argument
    ...
    if (CROSSVAL_RUN):
        ...
        full_run(range(1, TRAINING_SIZE+1), [])
